...
SOURCE = 'opendata.eselpoint.gov.cz (e-Sbirka SPARQL, CC BY 4.0)'
...
_FAMILIES: list[dict] = [{'name': 'Collection of Laws (Sbirka zakonu)', 'tool': 'cz_search / cz_get_act / cz_get_text'}]

_GAPS: list[dict] = [{'id': 'CZ-001', 'family': 'Collection of Laws (Sbirka zakonu)', 'missing': 'The ELI IRI is the Czech national one; it follows the ELI template but is not resolvable on data.europa.eu.', 'fallback': 'Use the human-readable page on e-sbirka.gov.cz.'}, {'id': 'CZ-002', 'family': 'Collection of Laws (Sbirka zakonu)', 'missing': 'Case law is not covered - this connector serves legislation only.', 'fallback': "Use the relevant Czech court's database."}, {'id': 'CZ-003', 'family': 'Collection of Laws (Sbirka zakonu)', 'missing': 'Legal force on a given date is not evaluated. Text is returned as the source publishes it; this connector does not decide whether a provision is in force.', 'fallback': 'Check the validity or consolidation dates on the source record itself.'}]
